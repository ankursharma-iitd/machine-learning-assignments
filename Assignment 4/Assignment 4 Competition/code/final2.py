...
model.add(Conv2D(128, (8, 8), padding = 'same', strides = 1, input_shape = input_shape, activation = 'relu', kernel_regularizer=l2(l2_lambda), kernel_initializer='glorot_normal'))
...
# model = load_model('my_best_model_2.h5')
